...
export const metadata: Metadata = {
  title: "CJFlixx - Watch TV Shows & Movies Online",
...
export default function RootLayout({
  ...
  return (
      <html lang="en" className="dark">
        ...
        <Toaster />
            <div>
              <Image unoptimized src={bg} alt="bg" className="w-screen blur-lg h-screen fixed top-0 left-0 right-0 bottom-0 -z-20 opacity-40" />
            </div>
            <NavigationMenuDemo />
            {children}
            <Footer />
